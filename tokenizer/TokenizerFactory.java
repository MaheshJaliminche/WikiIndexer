...
import edu.buffalo.cse.ir.wikiindexer.tokenizer.rules.Number;
import edu.buffalo.cse.ir.wikiindexer.tokenizer.rules.Punctuation;
import edu.buffalo.cse.ir.wikiindexer.tokenizer.rules.SpecialCharacter;
...
public class TokenizerFactory {
	...
	public Tokenizer getTokenizer(INDEXFIELD field) {
		...
		{
			try {
				//new Number(),new Stopwords(),new Apostrophe(),new Accent(),new SpecialCharacter(),new Punctuation(),new Hyphen(),new Capitalization(),new WhiteSpace(), new EnglishStemmer()
				return new Tokenizer(new Apostrophe(), new Capitalization(),new WhiteSpace(), new SpecialCharacter(),new Number(),new Stopwords(),new Punctuation(),new Accent(), new Hyphen());
		...
		{
			try {
				return new Tokenizer(new Capitalization(), new Apostrophe());
			} catch (TokenizerException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		{
			try {
				return new Tokenizer(new Apostrophe(), new Capitalization(),new WhiteSpace(), new SpecialCharacter(),new Number(),new Stopwords(),new Punctuation());
			} catch (TokenizerException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		{
			try {
				return new Tokenizer( new Capitalization(),new WhiteSpace(),new SpecialCharacter(),new Number(), new Stopwords(),new Punctuation());
			} catch (TokenizerException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
